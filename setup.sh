...
sudo apt-get install -y libreoffice unrar python3 python3-venv python3-pip tesseract-ocr tesseract-ocr-eng tesseract-ocr-rus tesseract-ocr-uzb tesseract-ocr-tur
